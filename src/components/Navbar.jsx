    ...
    return (
        ...
        <div className="w-full flex justify-between items-center font-semibold">
            ...
            {isAuth ? (
                ...
                className="px-4 py-1 cursor-pointer bg-red-500 text-black text-[15px] rounded-full"
                >
                Logout
                </p>
            ) : (
                ...
                className="px-4 py-1 cursor-pointer bg-green-500 text-black text-[15px] rounded-full"
                >
                Login
                </p>
            )}
